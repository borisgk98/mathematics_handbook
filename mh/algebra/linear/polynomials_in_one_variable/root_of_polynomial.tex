...
\index{корень многочлена}\textbf{Корнем} многочлена~$f(x)$ называется такое число~$a$, что $f(a) = 0$.

\index{теорема!Безу}\begin{theorem}[Безу]
...
% TODO полное доказательство

\index{основная теорема алгебры}\begin{theorem}[основная теорема алгебры]
